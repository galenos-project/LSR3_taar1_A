...
The p-value for the association between the number of ARRIVE guidelines reporting items and outcome reported  was `r round(SMD_S_LMA_ARRIVE_noI$QMp,3)`
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_cog__DrugSelectivity_noI <- subgroup_SMD(df, "TvC", "Cognition", "Selectivity", 0.5)
```
...
The p-value for the association between the number of ARRIVE guidelines reporting items and outcome reported was `r round(SMD_S_cog_ARRIVE_noI$QMp,3)`
