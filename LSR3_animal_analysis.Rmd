...
`r SMD_S_LMA[["k"]]` experimental comparisons were reported in `r SMD_S_LMA[["s.nlevels"]][3]` experiments reported from `r length(unique(SMD_S_LMA$data$StudyId))` publications and involving `r SMD_S_LMA[["s.nlevels"]][1]` different animal strains. The between strain variance was `r SMD_S_LMA$sigma2[1]`, the between study variance `r SMD_S_LMA$sigma2[2]` and the within-experiment variance `r SMD_S_LMA$sigma2[3]`.
...
The estimate for the change in effect per log unit change in standardised dose was `r SMD_S_LMA_StandardDose$metaregression_summary$beta[2]` (p `r if(round(SMD_S_LMA_StandardDose[["metaregression"]][["pval"]][2],3)>0.001){paste0('= ',round(SMD_S_LMA_StandardDose[["metaregression"]][["pval"]][2],3))}else{'< 0.001'}`). The between-strain variance was `r SMD_S_LMA_StandardDose$metaregression$sigma2[1]`, the between-study variance `r SMD_S_LMA_StandardDose$metaregression$sigma2[2]`, and the within-experiment variance `r SMD_S_LMA_StandardDose$metaregression$sigma2[3]`.
...
The estimate for the change in effect per log unit change in standardised dose was `r SMD_S_Cog_StandardDose$metaregression_summary$beta[2]` (p `r if(round(SMD_S_Cog_StandardDose[["metaregression"]][["pval"]][2],3)>0.001){paste0('= ',round(SMD_S_Cog_StandardDose[["metaregression"]][["pval"]][2],3))}else{'< 0.001'}`). The between-strain variance was `r SMD_S_Cog_StandardDose$metaregression$sigma2[1]`, the between-study variance `r SMD_S_Cog_StandardDose$metaregression$sigma2[2]`, and the within-experiment variance `r SMD_S_Cog_StandardDose$metaregression$sigma2[3]`.
...
|                 \-                  |   *8-11 criteria met*   |           `r SMD_S_Cog_ARRIVEI$beta[1]`           |                     `r SMD_S_Cog_ARRIVEI$ci.lb[1]` to `r SMD_S_Cog_ARRIVEI$ci.ub[1]`                     |                                 \-                                  |
|                 \-                  |  *12-15 criteria met*   |           `r SMD_S_Cog_ARRIVEI$beta[2]`           |                     `r SMD_S_Cog_ARRIVEI$ci.lb[2]` to `r SMD_S_Cog_ARRIVEI$ci.ub[2]`                     |                                 \-                                  |
|                 \-                  |  *16-19 criteria met*   |           `r SMD_S_Cog_ARRIVEI$beta[3]`           |                     `r SMD_S_Cog_ARRIVEI$ci.lb[3]` to `r SMD_S_Cog_ARRIVEI$ci.ub[3]`                     |                                 \-                                  |
...
<th><p></p></th>
<th><p></p></th>
<th><p>Homological validity</p></th>
<th><p>Ontopathogenic validity</p></th>
<th><p>Triggering validity</p></th>
<th><p>Mechanistic validity</p></th>
<th><p>Induction validity</p></th>
<th><p>Remission validity</p></th>
<th><p>Biomarker validity</p></th>
<th><p>Ethological validity</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p>Species and strain</p></td>
<td><p>Rat</p></td>
<td><p>We could find no evidence that the rat behavioural repertoire is closer to human than is the mouse</p></td>
<td><p>-</p></td>
<td><p>-</p></td>
<td></td>
<td><p>-</p></td>
...
<tr class="odd">
<td><p>Model Induction</p></td>
<td><p>Models using genetic induction – the DAT KO model</p></td>
<td><p>Polymorphisms in human SLC6A3 DAT gene reportedly associated with schizophrenia in some populations</p></td>
<td><p>-</p></td>
<td><p>Indirect DAT inhibitors such as methamphetamine can induce psychosis in humans.</p></td>
<td><p>The effect of indirect DAT inhibitors is thought to be mediated through TAAR1 agonism</p></td>
<td></td>
<td><p>-</p></td>
<td><p>-</p></td>
<td><p>-</p></td>
...
<tr class="even">
<td><p>Pharmacological</p>
<p>- psychostimulant models cocaine, amphetamine etc</p>
<p>- NMDA models phencyclidine PCP, MK801</p></td>
<td><p>-</p></td>
<td><p>No</p></td>
<td><p>MK801, ketamine, PCP and amphetamine induce psychosis and exacerbate symptoms in humans</p></td>
<td><p>Psychostimulant models induce mesolimbic dopamine dysregulation</p></td>
<td><p>1.The chronic PCP model has been associated with reduced brain volume; 2.EEG changes induced by amphetamine, PCP and MK801 are seen in human disease</p></td>
<td><p>1. In vivo EEG changes induced by amphetamine, PCP and MK801 are responsive to treatment</p></td>
<td><p>1. The chronic PCP model has been associated with reduced brain volume; 2. EEG changes induced by amphetamine, PCP and MK801 are seen in human disease</p></td>
<td></td>
<td></td>
</tr>
<tr class="odd">
<td><p>Outcome Measure</p></td>
<td><p>Locomotor activity</p></td>
<td><p>-</p></td>
<td><p>-</p></td>
<td><p>-</p></td>
<td></td>
<td></td>
<td><p>In a systematic review, Bahor found that known antipsychotic drugs improved locomotor activity in developmental models of psychosis. In house data from a Masters project 2015 suggests that some clozapine, aripiprazole, fluphenazine but not all eg olanzapine improve cocaine induced locomotor activity.</p></td>
<td><p>-</p></td>
<td><p>Neither psychomotor agitation nor Cognitive impairment are listed on the JLA schizophrenia PSP top 10, and so the ethological validity of these measures as relevant to unmet clinical need is uncertain</p></td>
</tr>
<tr class="even">
<td><p>Cognition</p></td>
<td><p>-</p></td>
...
<td></td>
<td></td>
<td><p>We could find no SRs of the effects of known antipsychotic drugs.</p></td>
<td><p>-</p></td>
<td></td>
<td></td>
</tr>
<tr class="odd">
<td><p>Additional experimental contrasts</p></td>
<td><p>T1A v other</p></td>
<td><p>-</p></td>
<td><p>-</p></td>
<td><p>-</p></td>
<td></td>
<td><p>-</p></td>
<td><p>In head-to-head experiments, T1A efficacy is non significantly lower than conventional antipsychotics</p></td>
<td><p>-</p></td>
<td><p>Relevant to potential use as monotherapy</p></td>
</tr>
<tr class="even">
<td><p>T1A + other v other</p></td>
<td><p>-</p></td>
<td><p>-</p></td>
<td><p>-</p></td>
<td></td>
<td><p>-</p></td>
<td><p>There is no effect of combined treatment compared with conventional antipsychotic drugs alone</p></td>
<td><p>-</p></td>
<td><p>Relevant to potential use as component of combination therapy</p></td>
<td></td>
</tr>
</tbody>
</table>
