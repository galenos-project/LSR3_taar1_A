...
4. Meta-analyses by experiment type and outcome
   ...
   - 4.2 "Head to head" (TAAR1 agonists v known antipsychotic drugs) experiments
...
forest_metafor(SMD_S_LMA, "Simple intervention", "locomotor activity")
```
...
forest_metafor(SMD_S_cog, "Simple intervention", "cognition")
```
...
**Figure n**
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=10}
forest_metafor(SMD_S_LMA_H2H, "Head to head", "locomotor activity")
```

### 4.2.2 Outcome 2: Cognition (a secondary outcome)

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_Cog_H2H <- run_ML_SMD(df, "Head to head", "Cognition", 0.5)
```
...
**Figure n**
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=10}
forest_metafor(SMD_S_Cog_H2H, "Head to Head","Cognition")
```
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_LMA_PC <- run_ML_SMD(df, "Positive control", "Locomotor activity", 0.5)
```

**Figure n**
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=10}
forest_metafor(SMD_S_LMA_PC, "Positive control","Locomotor activity")
```
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_S_Cog_PC <- run_ML_SMD(df, "Head to head", "Cognition", 0.5)
```

**Figure n**
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=10}
forest_metafor(SMD_S_Cog_PC, "Positive control","Cognition")
```
