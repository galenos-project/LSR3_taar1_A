...
```{r echo=FALSE}
 if (any(class(SMD_S_LMA) == "rma.mv")) {
  output_text3 <- paste0("For simple interventions, TAAR1 interventions had a pooled effect on locomotor activity of SMD = ", round(SMD_S_LMA[['beta']], 3), " (95% CI: ", round(SMD_S_LMA[['ci.lb']], 3), " to ", round(SMD_S_LMA[['ci.ub']], 3), ", with a prediction interval of", round(predict(SMD_S_LMA)$pi.lb, 3), " to ", round(predict(SMD_S_LMA)$pi.ub, 3))
...
```{r echo=FALSE}
if (any(class(SMD_S_cog) == "rma.mv")) {
  output_text3 <- paste0("For simple interventions, TAAR1 interventions had a pooled effect on cognitive outcomes of SMD =", round(SMD_S_cog[['beta']], 3), " (95% CI: ", round(SMD_S_cog[['ci.lb']], 3), " to ", round(SMD_S_cog[['ci.ub']], 3), ", with a prediction interval of", round(predict(SMD_S_cog)$pi.lb, 3), " to ", round(predict(SMD_S_cog)$pi.ub, 3))
...
```{r echo=FALSE}
 if (any(class(SMD_S_LMA_H2H) == "rma.mv")) {
  output_text1 <- "In Head to Head studies, the effect of administering a TAAR1 agonist on Locomotor activity in animals using SMD as the effect size is shown in Figure 4.2.1. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate."
  output_text2 <- "Figure 4.2.1"
} else {
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
 if (any(class(SMD_S_Cog_H2H) == "rma.mv")) {
  output_text1 <- "In Head to Head studies, the effect of administering a TAAR1 agonist on cognitive outcomes in animals using SMD as the effect size is shown in Figure 4.2.2. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate."
  output_text2 <- "Figure 4.2.2"
} else {
  output_text1 <- "Analysis is only performed if outcomes have been reported in more than one publication. There are not sufficient data for this analysis."
  output_text2 <- ""
}
...
```{r echo=FALSE}
 if (any(class(SMD_S_Cog_H2H) == "rma.mv")) {
  output_text3 <- paste0("For head to head comparisons, TAAR1 interventions had a pooled effect on cognitive outcomes of SMD = `r SMD_S_Cog_H2H[['beta']]` (95% CI: `r SMD_S_Cog_H2H[['ci.lb']]` to `r SMD_S_Cog_H2H[['ci.ub']]`) with a prediction interval of `r predict(SMD_S_Cog_H2H)$pi.lb` to `r predict(SMD_S_Cog_H2H)$pi.ub`.")
...
```{r echo=FALSE}
 if (any(class(SMD_S_LMA_PC) == "rma.mv")) {
  output_text1 <- "For positive control studies, the effect of administering a conventional antipsychotic drug on locomotor activity in animals using SMD as the effect size is shown in Figure 4.3.1. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate."
  output_text2 <- "Figure 4.3.1"
} else {
  output_text1 <- "Analysis is only performed if outcomes have been reported in more than one publication. There are not sufficient data for this analysis."
  output_text2 <- ""
}
...
```{r echo=FALSE}
 if (any(class(SMD_S_LMA_PC) == "rma.mv")) {
  output_text3 <- paste0("For positive control experiments, known antipsychotic drugs had a pooled effect on locomotor activity of SMD =", round(SMD_S_LMA_PC[['beta']], 3), " (95% CI: ", round(SMD_S_LMA_PC[['ci.lb']], 3), " to ", round(SMD_S_LMA_PC[['ci.ub']], 3),", with a prediction interval of ", round(predict(SMD_S_LMA_PC)$pi.lb, 3), " to ", round(predict(SMD_S_LMA_PC)$pi.ub, 3))
  output_text4 <- paste0("Between-strain variance was ", round(SMD_S_LMA_PC$sigma2[1], 3), ", between-study variance was ", round(SMD_S_LMA_PC$sigma2[2], 3), ", and within-study variance (between experiments) was ", round(SMD_S_LMA_PC$sigma2[3], 3))
} else {
  output_text3 <- ""
  output_text4 <- ""
}
...
```{r echo=FALSE}
 if (any(class(SMD_S_Cog_PC) == "rma.mv")) {
  output_text1 <- "For positive control experiments, the effect of administering a conventional antipsychotic drug on cognitive outcomes in animals using SMD as the effect size is shown in Figure 4.3.2. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate."
  output_text2 <- "Figure 4.3.2"
} else {
  output_text1 <- "Analysis is only performed if outcomes have been reported in more than one publication. There are not sufficient data for this analysis."
  output_text2 <- ""
}
...
```{r echo=FALSE}
 if (any(class(SMD_S_Cog_PC) == "rma.mv")) {
  output_text3 <- paste0("For positive control experiments, known antipsychotic drugs had a pooled effect on cognitive outcomes of SMD =", round(SMD_S_Cog_PC[['beta']], 3), " (95% CI: ", round(SMD_S_Cog_PC[['ci.lb']], 3), " to ", round(SMD_S_Cog_PC[['ci.ub']], 3),", with a prediction interval of ", round(predict(SMD_S_Cog_PC)$pi.lb, 3), " to ", round(predict(SMD_S_Cog_PC)$pi.ub, 3))
  output_text4 <- paste0("Between-strain variance was ", round(SMD_S_Cog_PC$sigma2[1], 3), ", between-study variance was ", round(SMD_S_Cog_PC$sigma2[2], 3), ", and within-study variance (between experiments) was ", round(SMD_S_Cog_PC$sigma2[3], 3))
} else {
  output_text3 <- ""
  output_text4 <- ""
}
...
```{r echo=FALSE}
 if (any(class(SMD_S_LMA_TAA) == "rma.mv")) {
  output_text1 <- "For combination studies, the effect of administering a TAAR1 agonist plus a conventional antipsychotic drug, compared with TAAR1 agonist alone, on locomotor activity in animals using SMD as the effect size is shown in Figure 4.4.1. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate."
  output_text2 <- "Figure 4.4.1"
} else {
  output_text1 <- "Analysis is only performed if outcomes have been reported in more than one publication. There are not sufficient data for this analysis."
  output_text2 <- ""
}
...
```{r echo=FALSE}
 if (any(class(SMD_S_Cog_TAA) == "rma.mv")) {
  output_text1 <- "For combination studies, the effect of administering a TAAR1 agonist plus a conventional antipsychotic drug, compared with TAAR1 agonist alone, on cognitive function in animals using SMD as the effect size is shown in Figure 4.4.2. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate."
  output_text2 <- "Figure 4.4.2"
} else {
  output_text1 <- "Analysis is only performed if outcomes have been reported in more than one publication. There are not sufficient data for this analysis."
  output_text2 <- ""
}
...
\* These variables were analysed as continuous variables, rather than categorical variables.
...
Note that in this iteration of the review, insufficient data was available to conduct subgroup analysis for the following variables, as only one subgroup level was present: `r check_moderator_levels(df, "TvC", "Cognition")`
...
Because of the relationship between SMD effect sizes and variance inherent in their calculation, where study size is small the standard approach to seeking evidence of small study effects (regression based tests including Egger's regression test for multilevel meta-analysis) can lead to over-estimation of small study effect (see for instance 10.7554/eLife.24260). To address this we offer two approaches using Egger's regression test for multilevel meta-analysis, being (i) Regression of SMD effect size against 1/√N, where N is the total number of animals involved in an experiment; and (ii) Regression of NMD effect size against SE (possible for `r ((df_S_LMA %>% filter(NMD_possible == "TRUE") %>% nrow())/(nrow(df_S_LMA)))*100` % of comparisons).

## 8.1.1 Egger's regression test for multilevel meta-analysis: SMD v 1/√N
...
<tbody>
<tr class="odd">
<td><p><strong>Source of evidence</strong>  </p></td>
<td><p><strong>Summary of the association</strong>  </p></td>
<td><p><strong>Bias due to study limitations</strong></p></td>
<td><p><strong>Bias due to reporting bias</strong></p></td>
<td><p><strong>Bias due to indirectedness</strong>  </p></td>
...
<td><p>Egger Regression showed conflicting results depending on the approach taken, with the SMD approach suggesting smaller studies report smaller effects, and the NMD approach suggesting smaller studies report larger effects.</p>
