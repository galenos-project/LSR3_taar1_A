...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
SMD_H2H_LMA <- run_ML_SMD(df, "Head to head", "Locomotor activity", 0.5)
```
...
**Figure n**
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=10}
forest_metafor(SMD_H2H_LMA, "Head to head", "locomotor activity")
```
...
For head to head comparisons, TAAR1 interventions had a pooled effect on cognitive outcomes  of SMD = `r SMD_S_Cog_H2H[["beta"]]` (95% CI: `r SMD_S_Cog_H2H[["ci.lb"]]` to `r SMD_S_Cog_H2H[["ci.ub"]]` with a prediction interval of `r predict(SMD_S_LMA_H2H)$pi.lb` to `r predict(SMD_S_LMA_H2H)$pi.ub`.
...
**Figure n**
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=10}
forest_metafor(SMD_S_Cog_H2H, "Cognition")
```
...
**Figure n**
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=10}
forest_metafor(SMD_S_LMA_PC, "Locomotor activity")
```
...
**Figure n**
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=10}
forest_metafor(SMD_S_Cog_PC, "Cognition")
```
