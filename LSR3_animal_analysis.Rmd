...
`r SMD_S_LMA[["k"]]` experimental comparisons were reported in `r SMD_S_LMA[["s.nlevels"]][3]` experiments reported from `r length(unique(SMD_S_LMA$data$StudyId))` publications and involving `r SMD_S_LMA[["s.nlevels"]][1]` different animal strains. 

| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
...
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA$s.names, SMD_S_LMA$s.nlevels[[which(SMD_S_LMA$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA$s.names, SMD_S_LMA$sigma2[[which(SMD_S_LMA$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA$s.names, SMD_S_LMA$s.nlevels[[which(SMD_S_LMA$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA$s.names, SMD_S_LMA$sigma2[[which(SMD_S_LMA$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_LMA_sex_noI$s.names, SMD_S_LMA_sex_noI$s.nlevels[[which(SMD_S_LMA_sex_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_LMA_sex_noI$s.names, SMD_S_LMA_sex_noI$sigma2[[which(SMD_S_LMA_sex_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_sex_noI$s.names, SMD_S_LMA_sex_noI$s.nlevels[[which(SMD_S_LMA_sex_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_sex_noI$s.names, SMD_S_LMA_sex_noI$sigma2[[which(SMD_S_LMA_sex_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_sex_noI$s.names, SMD_S_LMA_sex_noI$s.nlevels[[which(SMD_S_LMA_sex_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_sex_noI$s.names, SMD_S_LMA_sex_noI$sigma2[[which(SMD_S_LMA_sex_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_LMA_CatDisInd_noI$s.names, SMD_S_LMA_CatDisInd_noI$s.nlevels[[which(SMD_S_LMA_CatDisInd_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_LMA_CatDisInd_noI$s.names, SMD_S_LMA_CatDisInd_noI$sigma2[[which(SMD_S_LMA_CatDisInd_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_CatDisInd_noI$s.names, SMD_S_LMA_CatDisInd_noI$s.nlevels[[which(SMD_S_LMA_CatDisInd_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_CatDisInd_noI$s.names, SMD_S_LMA_CatDisInd_noI$sigma2[[which(SMD_S_LMA_CatDisInd_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_CatDisInd_noI$s.names, SMD_S_LMA_CatDisInd_noI$s.nlevels[[which(SMD_S_LMA_CatDisInd_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_CatDisInd_noI$s.names, SMD_S_LMA_CatDisInd_noI$sigma2[[which(SMD_S_LMA_CatDisInd_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_LMA_AdminRoute_noI$s.names, SMD_S_LMA_AdminRoute_noI$s.nlevels[[which(SMD_S_LMA_AdminRoute_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_LMA_AdminRoute_noI$s.names, SMD_S_LMA_AdminRoute_noI$sigma2[[which(SMD_S_LMA_AdminRoute_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_AdminRoute_noI$s.names, SMD_S_LMA_AdminRoute_noI$s.nlevels[[which(SMD_S_LMA_AdminRoute_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_AdminRoute_noI$s.names, SMD_S_LMA_AdminRoute_noI$sigma2[[which(SMD_S_LMA_AdminRoute_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_AdminRoute_noI$s.names, SMD_S_LMA_AdminRoute_noI$s.nlevels[[which(SMD_S_LMA_AdminRoute_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_AdminRoute_noI$s.names, SMD_S_LMA_AdminRoute_noI$sigma2[[which(SMD_S_LMA_AdminRoute_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_LMA_ProphThera_noI$s.names, SMD_S_LMA_ProphThera_noI$s.nlevels[[which(SMD_S_LMA_ProphThera_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_LMA_ProphThera_noI$s.names, SMD_S_LMA_ProphThera_noI$sigma2[[which(SMD_S_LMA_ProphThera_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_ProphThera_noI$s.names, SMD_S_LMA_ProphThera_noI$s.nlevels[[which(SMD_S_LMA_ProphThera_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_ProphThera_noI$s.names, SMD_S_LMA_ProphThera_noI$sigma2[[which(SMD_S_LMA_ProphThera_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_ProphThera_noI$s.names, SMD_S_LMA_ProphThera_noI$s.nlevels[[which(SMD_S_LMA_ProphThera_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_ProphThera_noI$s.names, SMD_S_LMA_ProphThera_noI$sigma2[[which(SMD_S_LMA_ProphThera_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_LMA_Drug_noI$s.names, SMD_S_LMA_Drug_noI$s.nlevels[[which(SMD_S_LMA_Drug_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_LMA_Drug_noI$s.names, SMD_S_LMA_Drug_noI$sigma2[[which(SMD_S_LMA_Drug_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_Drug_noI$s.names, SMD_S_LMA_Drug_noI$s.nlevels[[which(SMD_S_LMA_Drug_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_Drug_noI$s.names, SMD_S_LMA_Drug_noI$sigma2[[which(SMD_S_LMA_Drug_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_Drug_noI$s.names, SMD_S_LMA_Drug_noI$s.nlevels[[which(SMD_S_LMA_Drug_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_Drug_noI$s.names, SMD_S_LMA_Drug_noI$sigma2[[which(SMD_S_LMA_Drug_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_LMA_DrugEfficacy_noI$s.names, SMD_S_LMA_DrugEfficacy_noI$s.nlevels[[which(SMD_S_LMA_DrugEfficacy_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_LMA_DrugEfficacy_noI$s.names, SMD_S_LMA_DrugEfficacy_noI$sigma2[[which(SMD_S_LMA_DrugEfficacy_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_DrugEfficacy_noI$s.names, SMD_S_LMA_DrugEfficacy_noI$s.nlevels[[which(SMD_S_LMA_DrugEfficacy_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_DrugEfficacy_noI$s.names, SMD_S_LMA_DrugEfficacy_noI$sigma2[[which(SMD_S_LMA_DrugEfficacy_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_DrugEfficacy_noI$s.names, SMD_S_LMA_DrugEfficacy_noI$s.nlevels[[which(SMD_S_LMA_DrugEfficacy_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_DrugEfficacy_noI$s.names, SMD_S_LMA_DrugEfficacy_noI$sigma2[[which(SMD_S_LMA_DrugEfficacy_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_LMA_DrugSelectivity_noI$s.names, SMD_S_LMA_DrugSelectivity_noI$s.nlevels[[which(SMD_S_LMA_DrugSelectivity_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_LMA_DrugSelectivity_noI$s.names, SMD_S_LMA_DrugSelectivity_noI$sigma2[[which(SMD_S_LMA_DrugSelectivity_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_DrugSelectivity_noI$s.names, SMD_S_LMA_DrugSelectivity_noI$s.nlevels[[which(SMD_S_LMA_DrugSelectivity_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_DrugSelectivity_noI$s.names, SMD_S_LMA_DrugSelectivity_noI$sigma2[[which(SMD_S_LMA_DrugSelectivity_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_DrugSelectivity_noI$s.names, SMD_S_LMA_DrugSelectivity_noI$s.nlevels[[which(SMD_S_LMA_DrugSelectivity_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_DrugSelectivity_noI$s.names, SMD_S_LMA_DrugSelectivity_noI$sigma2[[which(SMD_S_LMA_DrugSelectivity_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_potency$metaregression_summary$s.names, SMD_S_LMA_potency$metaregression_summary$s.nlevels[[which(SMD_S_LMA_potency$metaregression_summary$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_potency$metaregression_summary$s.names, SMD_S_LMA_potency$metaregression_summary$sigma2[[which(SMD_S_LMA_potency$metaregression_summary$s.names == 'Strain/StudyId')]], NA)`|
...
In this iteration of the review, the TAAR1 agonists tested against control for their effect on locomotor activity were: **`r drugs <- df %>% filter(SortLabel == "TvC") %>% filter(outcome_type == "Locomotor activity") %>% group_by(DrugName) %>% summarise(count = n()) %>% arrange(desc(count)) %>% pull(DrugName); if (length(drugs) > 1) {paste(paste(head(drugs, -1), collapse = ", "), "and", tail(drugs, 1))} else {drugs}`**. <!--# TO ADD IN THE METHODS SECTION: Meta-regression using the administered dose as an explanatory variable was conducted for each drug where this had been reported in 10 or more experiments from 3 or more publications. --> Meta-analysis was conducted where data were available from more than nine experiemnts in more than two publications. The dashed lines in the plot represent the 95% confidence interval of the regression line and the dotted lines represent the 95% prediction interval. Raw data are plotted with point size adjusted according to effect size precision.
...
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_SEP363856_dose$s.names, SMD_S_LMA_SEP363856_dose$s.nlevels[[which(SMD_S_LMA_SEP363856_dose$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_SEP363856_dose$s.names, SMD_S_LMA_SEP363856_dose$sigma2[[which(SMD_S_LMA_SEP363856_dose$s.names == 'Strain/StudyId')]], NA)`|
...
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_StandardDose$metaregression_summary$s.names, SMD_S_LMA_StandardDose$metaregression_summary$s.nlevels[[which(SMD_S_LMA_StandardDose$metaregression_summary$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_StandardDose$metaregression_summary$s.names, SMD_S_LMA_StandardDose$metaregression_summary$sigma2[[which(SMD_S_LMA_StandardDose$metaregression_summary$s.names == 'Strain/StudyId')]], NA)`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_LMA_SyRCLERoB_noI$s.names, SMD_S_LMA_SyRCLERoB_noI$s.nlevels[[which(SMD_S_LMA_SyRCLERoB_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_LMA_SyRCLERoB_noI$s.names, SMD_S_LMA_SyRCLERoB_noI$sigma2[[which(SMD_S_LMA_SyRCLERoB_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_SyRCLERoB_noI$s.names, SMD_S_LMA_SyRCLERoB_noI$s.nlevels[[which(SMD_S_LMA_SyRCLERoB_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_SyRCLERoB_noI$s.names, SMD_S_LMA_SyRCLERoB_noI$sigma2[[which(SMD_S_LMA_SyRCLERoB_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_SyRCLERoB_noI$s.names, SMD_S_LMA_SyRCLERoB_noI$s.nlevels[[which(SMD_S_LMA_SyRCLERoB_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_SyRCLERoB_noI$s.names, SMD_S_LMA_SyRCLERoB_noI$sigma2[[which(SMD_S_LMA_SyRCLERoB_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_LMA_SyRCLERoBTF_noI$s.names, SMD_S_LMA_SyRCLERoBTF_noI$s.nlevels[[which(SMD_S_LMA_SyRCLERoBTF_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_LMA_SyRCLERoBTF_noI$s.names, SMD_S_LMA_SyRCLERoBTF_noI$sigma2[[which(SMD_S_LMA_SyRCLERoBTF_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_SyRCLERoBTF_noI$s.names, SMD_S_LMA_SyRCLERoBTF_noI$s.nlevels[[which(SMD_S_LMA_SyRCLERoBTF_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_SyRCLERoBTF_noI$s.names, SMD_S_LMA_SyRCLERoBTF_noI$sigma2[[which(SMD_S_LMA_SyRCLERoBTF_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_SyRCLERoBTF_noI$s.names, SMD_S_LMA_SyRCLERoBTF_noI$s.nlevels[[which(SMD_S_LMA_SyRCLERoBTF_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_SyRCLERoBTF_noI$s.names, SMD_S_LMA_SyRCLERoBTF_noI$sigma2[[which(SMD_S_LMA_SyRCLERoBTF_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|

#### ARRIVE reporting completeness guidelines

Figure 2.1.4.13 displays a visualisation of the meta-regression using the number of ARRIVE items met (from a possible total of 23) as an explanatory variable. Dashed lines represent the 95% confidence interval of the regression line. The dotted lines represent the 95% prediction interval. Raw data are plotted with 'bubble' size adjusted according to effect size precision.
...
|                    \-                    |        *Genetic*        |         `r SMD_S_LMA_CatDisIndI$beta[1]`          |                `r SMD_S_LMA_CatDisIndI$ci.lb[1]` to `r SMD_S_LMA_CatDisInd_noI$ci.ub[1]`                 |                                 \-                                  |
...
|                    \-                    |     *Compound 50B*      |            `r SMD_S_LMA_DrugI$beta[3]`            |                    `r SMD_S_LMA_Drug_noI$ci.lb[3]` to `r SMD_S_LMA_Drug_noI$ci.ub[3]`                    |                                 \-                                  |
...
`r NMD_S_LMA[["k"]]` experimental comparisons were reported in `r NMD_S_LMA[["s.nlevels"]][3]` experiments reported from `r length(unique(NMD_S_LMA$data$StudyId))` publications and involving `r NMD_S_LMA[["s.nlevels"]][1]` different animal strains. 
...
| Study |`r ifelse('Strain/StudyId' %in% NMD_S_LMA$s.names, NMD_S_LMA$s.nlevels[[which(NMD_S_LMA$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% NMD_S_LMA$s.names, NMD_S_LMA$sigma2[[which(NMD_S_LMA$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% NMD_S_LMA$s.names, NMD_S_LMA$s.nlevels[[which(NMD_S_LMA$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% NMD_S_LMA$s.names, NMD_S_LMA$sigma2[[which(NMD_S_LMA$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Study |`r ifelse('Strain/StudyId' %in% run_sse_SMD_L(df)$s.names, run_sse_SMD_L(df)$s.nlevels[[which(run_sse_SMD_L(df)$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% run_sse_SMD_L(df)$s.names, run_sse_SMD_L(df)$sigma2[[which(run_sse_SMD_L(df)$s.names == 'Strain/StudyId')]], NA)`|
...
`r SMD_S_Cog[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_Cog[["data"]][["ExperimentId"]]))` experiments reported from `r length(unique(SMD_S_Cog$data$StudyId))` publications and involving `r SMD_S_Cog[["s.nlevels"]][1]` different animal strains. 
...
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_Cog$s.names, SMD_S_Cog$s.nlevels[[which(SMD_S_Cog$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_Cog$s.names, SMD_S_Cog$sigma2[[which(SMD_S_Cog$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog$s.names, SMD_S_Cog$s.nlevels[[which(SMD_S_Cog$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog$s.names, SMD_S_Cog$sigma2[[which(SMD_S_Cog$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_Cog_sex_noI$s.names, SMD_S_Cog_sex_noI$s.nlevels[[which(SMD_S_Cog_sex_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_Cog_sex_noI$s.names, SMD_S_Cog_sex_noI$sigma2[[which(SMD_S_Cog_sex_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_Cog_sex_noI$s.names, SMD_S_Cog_sex_noI$s.nlevels[[which(SMD_S_Cog_sex_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_Cog_sex_noI$s.names, SMD_S_Cog_sex_noI$sigma2[[which(SMD_S_Cog_sex_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_sex_noI$s.names, SMD_S_Cog_sex_noI$s.nlevels[[which(SMD_S_Cog_sex_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_sex_noI$s.names, SMD_S_Cog_sex_noI$sigma2[[which(SMD_S_Cog_sex_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_Cog_CatDisInd_noI$s.names, SMD_S_Cog_CatDisInd_noI$s.nlevels[[which(SMD_S_Cog_CatDisInd_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_Cog_CatDisInd_noI$s.names, SMD_S_Cog_CatDisInd_noI$sigma2[[which(SMD_S_Cog_CatDisInd_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_Cog_CatDisInd_noI$s.names, SMD_S_Cog_CatDisInd_noI$s.nlevels[[which(SMD_S_Cog_CatDisInd_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_Cog_CatDisInd_noI$s.names, SMD_S_Cog_CatDisInd_noI$sigma2[[which(SMD_S_Cog_CatDisInd_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_CatDisInd_noI$s.names, SMD_S_Cog_CatDisInd_noI$s.nlevels[[which(SMD_S_Cog_CatDisInd_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_CatDisInd_noI$s.names, SMD_S_Cog_CatDisInd_noI$sigma2[[which(SMD_S_Cog_CatDisInd_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_Cog_AdminRoute_noI$s.names, SMD_S_Cog_AdminRoute_noI$s.nlevels[[which(SMD_S_Cog_AdminRoute_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_Cog_AdminRoute_noI$s.names, SMD_S_Cog_AdminRoute_noI$sigma2[[which(SMD_S_Cog_AdminRoute_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_Cog_AdminRoute_noI$s.names, SMD_S_Cog_AdminRoute_noI$s.nlevels[[which(SMD_S_Cog_AdminRoute_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_Cog_AdminRoute_noI$s.names, SMD_S_Cog_AdminRoute_noI$sigma2[[which(SMD_S_Cog_AdminRoute_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_AdminRoute_noI$s.names, SMD_S_Cog_AdminRoute_noI$s.nlevels[[which(SMD_S_Cog_AdminRoute_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_AdminRoute_noI$s.names, SMD_S_Cog_AdminRoute_noI$sigma2[[which(SMD_S_Cog_AdminRoute_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_Cog_Drug_noI$s.names, SMD_S_Cog_Drug_noI$s.nlevels[[which(SMD_S_Cog_Drug_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_Cog_Drug_noI$s.names, SMD_S_Cog_Drug_noI$sigma2[[which(SMD_S_Cog_Drug_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_Cog_Drug_noI$s.names, SMD_S_Cog_Drug_noI$s.nlevels[[which(SMD_S_Cog_Drug_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_Cog_Drug_noI$s.names, SMD_S_Cog_Drug_noI$sigma2[[which(SMD_S_Cog_Drug_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_Drug_noI$s.names, SMD_S_Cog_Drug_noI$s.nlevels[[which(SMD_S_Cog_Drug_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_Drug_noI$s.names, SMD_S_Cog_Drug_noI$sigma2[[which(SMD_S_Cog_Drug_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_Cog_DrugSelectivity_noI$s.names, SMD_S_Cog_DrugSelectivity_noI$s.nlevels[[which(SMD_S_Cog_DrugSelectivity_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_Cog_DrugSelectivity_noI$s.names, SMD_S_Cog_DrugSelectivity_noI$sigma2[[which(SMD_S_Cog_DrugSelectivity_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_Cog_DrugSelectivity_noI$s.names, SMD_S_Cog_DrugSelectivity_noI$s.nlevels[[which(SMD_S_Cog_DrugSelectivity_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_Cog_DrugSelectivity_noI$s.names, SMD_S_Cog_DrugSelectivity_noI$sigma2[[which(SMD_S_Cog_DrugSelectivity_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_DrugSelectivity_noI$s.names, SMD_S_Cog_DrugSelectivity_noI$s.nlevels[[which(SMD_S_Cog_DrugSelectivity_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_DrugSelectivity_noI$s.names, SMD_S_Cog_DrugSelectivity_noI$sigma2[[which(SMD_S_Cog_DrugSelectivity_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_Cog_potency$metaregression_summary$s.names, SMD_S_Cog_potency$metaregression_summary$s.nlevels[[which(SMD_S_Cog_potency$metaregression_summary$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_Cog_potency$metaregression_summary$s.names, SMD_S_Cog_potency$metaregression_summary$sigma2[[which(SMD_S_Cog_potency$metaregression_summary$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_potency$metaregression_summary$s.names, SMD_S_Cog_potency$metaregression_summary$s.nlevels[[which(SMD_S_Cog_potency$metaregression_summary$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_potency$metaregression_summary$s.names, SMD_S_Cog_potency$metaregression_summary$sigma2[[which(SMD_S_Cog_potency$metaregression_summary$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_Cog_StandardDose$s.names, SMD_S_Cog_StandardDose$s.nlevels[[which(SMD_S_Cog_StandardDose$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_Cog_StandardDose$s.names, SMD_S_Cog_StandardDose$sigma2[[which(SMD_S_Cog_StandardDose$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_Cog_StandardDose$s.names, SMD_S_Cog_StandardDose$s.nlevels[[which(SMD_S_Cog_StandardDose$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_Cog_StandardDose$s.names, SMD_S_Cog_StandardDose$sigma2[[which(SMD_S_Cog_StandardDose$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_StandardDose$s.names, SMD_S_Cog_StandardDose$s.nlevels[[which(SMD_S_Cog_StandardDose$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_StandardDose$s.names, SMD_S_Cog_StandardDose$sigma2[[which(SMD_S_Cog_StandardDose$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_Cog_SyRCLERoB_noI$s.names, SMD_S_Cog_SyRCLERoB_noI$s.nlevels[[which(SMD_S_Cog_SyRCLERoB_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_Cog_SyRCLERoB_noI$s.names, SMD_S_Cog_SyRCLERoB_noI$sigma2[[which(SMD_S_Cog_SyRCLERoB_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_Cog_SyRCLERoB_noI$s.names, SMD_S_Cog_SyRCLERoB_noI$s.nlevels[[which(SMD_S_Cog_SyRCLERoB_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_Cog_SyRCLERoB_noI$s.names, SMD_S_Cog_SyRCLERoB_noI$sigma2[[which(SMD_S_Cog_SyRCLERoB_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_SyRCLERoB_noI$s.names, SMD_S_Cog_SyRCLERoB_noI$s.nlevels[[which(SMD_S_Cog_SyRCLERoB_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_Cog_SyRCLERoB_noI$s.names, SMD_S_Cog_SyRCLERoB_noI$sigma2[[which(SMD_S_Cog_SyRCLERoB_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_cog_SyRCLERoBTF_noI$s.names, SMD_S_cog_SyRCLERoBTF_noI$s.nlevels[[which(SMD_S_cog_SyRCLERoBTF_noI$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_cog_SyRCLERoBTF_noI$s.names, SMD_S_cog_SyRCLERoBTF_noI$sigma2[[which(SMD_S_cog_SyRCLERoBTF_noI$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_cog_SyRCLERoBTF_noI$s.names, SMD_S_cog_SyRCLERoBTF_noI$s.nlevels[[which(SMD_S_cog_SyRCLERoBTF_noI$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_cog_SyRCLERoBTF_noI$s.names, SMD_S_cog_SyRCLERoBTF_noI$sigma2[[which(SMD_S_cog_SyRCLERoBTF_noI$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_cog_SyRCLERoBTF_noI$s.names, SMD_S_cog_SyRCLERoBTF_noI$s.nlevels[[which(SMD_S_cog_SyRCLERoBTF_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_cog_SyRCLERoBTF_noI$s.names, SMD_S_cog_SyRCLERoBTF_noI$sigma2[[which(SMD_S_cog_SyRCLERoBTF_noI$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Level| Number of instances | Attributable variance  | 
|:-------------:|:-------------:|:-------------:|
| Strain |`r ifelse('Strain' %in% SMD_S_cog_ARR2$s.names, SMD_S_cog_ARR2$s.nlevels[[which(SMD_S_cog_ARR2$s.names == 'Strain')]], 0)`|`r ifelse('Strain' %in% SMD_S_cog_ARR2$s.names, SMD_S_cog_ARR2$sigma2[[which(SMD_S_cog_ARR2$s.names == 'Strain')]], NA)`|
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_cog_ARR2$s.names, SMD_S_cog_ARR2$s.nlevels[[which(SMD_S_cog_ARR2$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_cog_ARR2$s.names, SMD_S_cog_ARR2$sigma2[[which(SMD_S_cog_ARR2$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_cog_ARR2$s.names, SMD_S_cog_ARR2$s.nlevels[[which(SMD_S_cog_ARR2$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_cog_ARR2$s.names, SMD_S_cog_ARR2$sigma2[[which(SMD_S_cog_ARR2$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
`r NMD_S_cog[["k"]]` experimental comparisons were reported in `r NMD_S_cog[["s.nlevels"]][3]` experiments reported from `r length(unique(NMD_S_cog$data$StudyId))` publications and involving `r NMD_S_cog[["s.nlevels"]][1]` different animal strains. 
...
| Study |`r ifelse('Strain/StudyId' %in% NMD_S_cog$s.names, NMD_S_cog$s.nlevels[[which(NMD_S_cog$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% NMD_S_cog$s.names, NMD_S_cog$sigma2[[which(NMD_S_cog$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% NMD_S_cog$s.names, NMD_S_cog$s.nlevels[[which(NMD_S_cog$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% NMD_S_cog$s.names, NMD_S_cog$sigma2[[which(NMD_S_cog$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
| Study |`r ifelse('Strain/StudyId' %in% run_sse_SMD_C(df)$s.names, run_sse_SMD_C(df)$s.nlevels[[which(run_sse_SMD_C(df)$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% run_sse_SMD_C(df)$s.names, run_sse_SMD_C(df)$sigma2[[which(run_sse_SMD_C(df)$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% run_sse_SMD_C(df)$s.names, run_sse_SMD_C(df)$s.nlevels[[which(run_sse_SMD_C(df)$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% run_sse_SMD_C(df)$s.names, run_sse_SMD_C(df)$sigma2[[which(run_sse_SMD_C(df)$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
`r SMD_S_LMA_H2H[["k"]]` experimental comparisons were reported in `r length(unique(SMD_S_LMA_H2H[["data"]][["ExperimentId"]]))` experiments reported from `r  length(unique(SMD_S_LMA_H2H$data$StudyId))` publications and involving `r SMD_S_LMA_H2H[["s.nlevels"]][1]` different animal strains. 
...
| Study |`r ifelse('Strain/StudyId' %in% SMD_S_LMA_H2H$s.names, SMD_S_LMA_H2H$s.nlevels[[which(SMD_S_LMA_H2H$s.names == 'Strain/StudyId')]], 0)`| `r ifelse('Strain/StudyId' %in% SMD_S_LMA_H2H$s.names, SMD_S_LMA_H2H$sigma2[[which(SMD_S_LMA_H2H$s.names == 'Strain/StudyId')]], NA)`|
| Experiment |`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_H2H$s.names, SMD_S_LMA_H2H$s.nlevels[[which(SMD_S_LMA_H2H$s.names == 'Strain/StudyId/ExperimentID_I')]], 0)`|`r ifelse('Strain/StudyId/ExperimentID_I' %in% SMD_S_LMA_H2H$s.names, SMD_S_LMA_H2H$sigma2[[which(SMD_S_LMA_H2H$s.names == 'Strain/StudyId/ExperimentID_I')]], 'NA')`|
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide'}
 if (any(class(SMD_S_Cog_H2H) == "rma.mv")) {
  ...
  output_text2 <- "Figure 3.2 - Forest plot of cognitive function for TAAR1 Agonist vs known antipychotic drug"
} else {
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=6, fig.width=10}
forest_metafor(SMD_S_Cog_H2H, "TvA", "Cognition")
```

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=6, fig.width=10}
 if (!any(class(SMD_S_Cog_H2H) == "rma.mv")) {
   forest_metafor(SMD_Cog_H2H, "TvA","Cognition")}
```
...
```{r echo=FALSE}
 if (any(class(SMD_S_Cog_TAA) == "rma.mv")) {
  ...
  output_text2 <- "Figure 4.2 - Forest plot of cognitive function for TAAR1 Agonist + known antipsychotic vs known antipychotic alone"
} else {
  output_text1 <- "Multilevel analysis is only performed if there are 5 levels or more for at least one of Strain, Study and Experiment, and that is not the case here. We provide a conventional univariate random effects model to illustrate the data"
  output_text2 <- ""
}
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=7, fig.width=11}
...
```{r echo=FALSE}
 if (any(class(SMD_S_LMA_KO) == "rma.mv")) {
  output_text1 <- "For combination studies, the effect of administering a TAAR1 agonist plus a conventional antipsychotic drug, compared with TAAR1 agonist alone, on cognitive function in animals using SMD as the effect size is shown in Figure 5.1. The pooled estimate for SMD across all individual comparisons is displayed as a diamond shape at the bottom of the plot. Dotted lines indicate the prediction interval of the pooled estimate."
...
```{r echo = FALSE}
SoE_TvC <- read_xlsx("data/soe_tables_20240201.xlsx", "TvC")
...
```{r echo = FALSE}
SoE_TvA <- read_xlsx("data/soe_tables_20240201.xlsx", "TvA")
...
**Reasons for high risk of indirectness:** All experiments were in rodents (low homological validity); no models manipulated early environmental factors (low ontopathogenic validity); no models assessed outcomes identified by the JLA schizophrenia PSP top 10 (low ethological validity)

**Reasons for moderate risk of indirectness:** For models using DAT ko, the homologous human gene is associated with schizophrenia in some populations (homological validity); indirect DAT inhibitors can cause psychosis in humans (triggering validity); and the effect of indirect DAT inhibitors is reported to be mediated through TAAR1 agonism. For pharmacological models, the agents used in animal models induce psychosis and exacerbate symptoms in humans (triggering validity), induce EEG changes in humans and animals (induction validity, biomarker validity) which are responsive to treatment in vivo (remission validity). Psychostimulant models induce mesolimbic dopamine dysregulation (mechanistic validity) and the PCP model is associated with reduced brain volume, also seen in human disease (mechanistic validity, biomarker validity).

**Reasons for moderate risk of indirectness - Locomotor activity:** In systematic review of animal data, known antipsychotic drugs improve locomotor activity in developmental models of psychosis, and some antipsychotics improve cocaine induced locomotor activity (remission validity). Psychomotor agitation is a recognised feature of human psychosis (ethological validity). The interventions used to induce locomotor activity in animals (e.g. cocaine, amphetamine) were usually only given as a single exposure (trigerring validity).

**Reasons for moderate risk of indirectness - Cognitive outcomes:** Impaired cognitive function is a recognised feature of human psychosis.

**Unknown risk of indirectness:** We could find no systematic reviews of the effects of known antipsychotic drugs on cognition in animals.
...
```{r echo = FALSE}
SoE_Indir <- read_xlsx("data/soe_tables_20240201.xlsx", "Indir") ### ? where is this##
