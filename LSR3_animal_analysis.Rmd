...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=10, fig.width=12}
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=8, fig.width=11}
