...
3.  Risk of bias and reporting completeness assessment
    ...
    -   3.1 TAAR1 Agonist v Control
        ...
        -   3.1.1 Outcome 1: Locomotor activity
            ...
            -   3.1.1.2 Reporting completeness

        -   3.1.3 Outcome 2: Cognition

            -   3.1.2.1 Risks of bias

            -   3.1.2.2 Reporting completeness
...
5.  Subgroup analyses and meta-regression
    ...
    -   5.1 TAAR1 Agonist v Control
        ...
        -   5.1.1 Outcome 1: Locomotor activity
            ...
            -   5.1.1.12 ARRIVE reporting completeness guidelines
        ...
        -   5.1.2 Outcome 2: Cognition
            ...
            -   5.1.2.12 ARRIVE reporting completeness guidelines
...
Figure 3.1.1.2.1 shows the reporting completeness summary for studies investigating the effect of administering a TAAR1 agonist on locomotor activity in animals. The reporting completeness assessment was performed using the ARRIVE guidelines. Figure 3.1.1.2.2 shows the corresponding traffic light plot.
...
###### 3.1.2.2 Reporting completeness
#
#Figure 3.1.2.2.1 shows the reporting completeness summary for studies investigating the effect of administering a TAAR1 agonist on prepulse inhibition in animals. The reporting #completeness assessment was performed using the ARRIVE guidelines. Figure 3.1.2.2.2 shows the corresponding traffic light plot.
#
#**Figure 3.1.2.2.1**
#
...
Figure 3.1.2.2.1 shows the reporting completeness summary for studies investigating the effect of administering a TAAR1 agonist on cognition in animals. The reporting completeness assessment was performed using the ARRIVE guidelines. Figure 3.1.2.2.2 shows the corresponding traffic light plot.
...
#```
#
##### 3.1.4.2 Reporting completeness
#
#Figure 3.1.4.2.1 shows the reporting completeness summary for studies investigating the effect of administering a TAAR1 agonist on social interaction in animals. The reporting #completeness assessment was performed using the ARRIVE guidelines. Figure 3.1.4.2.2 shows the corresponding traffic light plot.
#
#**Figure 3.1.4.2.1**
#
#```{r warning=FALSE, eval = TRUE, echo = FALSE}
...
###### 3.1.5.2 Reporting completeness

#Figure 3.1.5.2.1 shows the reporting completeness summary for studies investigating the effect of administering a TAAR1 agonist on stereotypy in animals. The reporting completeness #assessment was performed using the ARRIVE guidelines. Figure 3.1.5.2.2 shows the corresponding traffic light plot.
...
## 8.1 Egger regression for small study effects
...
<td><p>Egger Regression showed conflicting results depending on the approach taken, with the SMD approach suggesting smaller studies report larger effects, and the NMD approach suggesting less precise studies report smaller effects.</p>
