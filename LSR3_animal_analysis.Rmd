...
```{r echo = FALSE}
SoE_TvA <- read_excel("data/soe_tables_20240201.xlsx", "TvA")
...
```{r echo = FALSE}
SoE_Indir <- read.xlsx("data/soe_tables_20240201.xlsx", "Indir")
