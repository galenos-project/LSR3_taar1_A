...
`r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "B: 4-7 criteria met", "k"]` experiments met between 4 and 7 of the ARRIVE reporting quality criteria. `r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "C: 8-11 criteria met", "k"]` experiments met between 8 and 11, `r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "D: 12-15 criteria met", "k"]` experiments met between 12 and 15, `r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "E: 16-19 criteria met", "k"]` experiments met between 16 and 19 and `r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "F: 20-23 criteria met", "k"]` experiments met between 20 and 23. No experiment met below 4 of the ARRIVE reporting quality criteria.

The pooled SMD estimate for the effect of TAAR1 agonists on locomotor activity in experiments that met between 4 and 7 of the ARRIVE reporting quality criteria was `r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "4-7 criteria met", "SMD"]`. The estimate for experiments that met between 8 and 11 of the ARRIVE reporting quality criteria was `r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "8-11 criteria met", "SMD"]`, for those experiments that met between 12 and 15 of the ARRIVE reporting quality criteria `r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "12-15 criteria met", "SMD"]`, for those experiments that met between 16 and 19 of the ARRIVE reporting quality criteria `r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "16-19 criteria met", "SMD"]`, and for those experiments that met between 20 and 23 of the ARRIVE reporting quality criteria `r SMD_S_LMA_ARRIVE$subgroup_rma_summary[SMD_S_LMA_ARRIVE$subgroup_rma_summary$ARRIVEScoreCat == "20-23 criteria met", "SMD"]`.
...
| - | *Pharmacological* | `r SMD_S_LMA_CatDisInd$subgroup_analysis$beta[1]` | `r SMD_S_LMA_CatDisInd$subgroup_analysis$ci.lb[1]` - `r SMD_S_LMA_CatDisInd$subgroup_analysis$ci.ub[1]` | - | - |
| - | *Genetic* | `r SMD_S_LMA_CatDisInd$subgroup_analysis$beta[2]` | `r SMD_S_LMA_CatDisInd$subgroup_analysis$ci.lb[2]` - `r SMD_S_LMA_CatDisInd$subgroup_analysis$ci.ub[2]` | - | - |
...
| - | *Oral* | `r SMD_S_LMA_AdminRoute$subgroup_analysis$beta[1]` | `r SMD_S_LMA_AdminRoute$subgroup_analysis$ci.lb[1]` - `r SMD_S_LMA_AdminRoute$subgroup_analysis$ci.ub[1]` | - | - |
| - | *Intraperitoneal* | `r SMD_S_LMA_AdminRoute$subgroup_analysis$beta[2]` | `r SMD_S_LMA_AdminRoute$subgroup_analysis$ci.lb[2]` - `r SMD_S_LMA_AdminRoute$subgroup_analysis$ci.ub[2]` | - | - |
...
| - | *SEP-363856 (Ultaront)* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[1]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[1]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[1]` | - | - |
| - | *RO5203648* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[2]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[2]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[2]` | - | - |
| - | *RO5166017* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[3]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[3]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[3]` | - | - |
| - | *RO5263397* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[4]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[4]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[4]` | - | - |
| - | *RO5256390* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[5]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[5]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[5]` | - | - |
| - | *RO5073012* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[6]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[6]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[6]` | - | - |
| - | *Compound 50B* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[7]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[7]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[7]` | - | - |
| - | *LK000764* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[8]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[8]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[8]` | - | - |
| - | *Compound 50A* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[9]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[9]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[9]` | - | - |
| - | *AP163* | `r SMD_S_LMA_Drug$subgroup_analysis$beta[10]` | `r SMD_S_LMA_Drug$subgroup_analysis$ci.lb[10]` - `r SMD_S_LMA_Drug$subgroup_analysis$ci.ub[10]` | - | - |
