...
1.  Flow of study selection and descriptives
    ...
    -   1.1 Description of experiment types
        -   1.1.1 TAAR1 Agonist v Control

2.  Risk of bias and reporting completeness assessment

    -   2.1 TAAR1 Agonist v Control

        -   2.1.1 Outcome 1: Locomotor activity

            -   2.1.1.1 Risks of bias

            -   2.1.1.2 Reporting completeness

        -   2.1.2 Outcome 2: Cognition

            -   2.1.2.1 Risks of bias

            -   2.1.2.2 Reporting completeness

3.  Meta-analyses by experiment type and outcome
...
4.  Subgroup analyses and meta-regression
...
6.  Reporting bias/small study effects
...
### 3.1.1 Outcome 1: Locomotor activity (a primary outcome)
...
### 3.1.2 Outcome 2: Cognition (a secondary outcome)
...
## 3.2 "TAAR1 Agonist v known antipsychotic drug" (TAAR1 Ag v known antipsychotic drugs) experiments

### 3.2.1 Outcome 1: Locomotor activity (a primary outcome)
...
### 3.2.2 Outcome 2: Cognition (a secondary outcome)
...
# 3.3 Co-treatment with TAAR1 agonist plus know antipsychotic drug v known antipsychotic drug alone

### 3.3.1 Outcome 1: Locomotor activity (a primary outcome)
...
### 3.3.2 Outcome 2: Cognition (a secondary outcome)
...
# 4. Subgroup analyses and meta-regressions
...
<!--# are you only doing meta-regressions and subgroup analyses for this experiment type? if so there is no need for the heading, just state this in the previous section -->
...
#### 4.1.1.2 Category of disease induction
...
#### 4.1.1.3 Route of intervention administration
...
#### 4.1.1.4 Prophylactic or therapeutic intervention
...
#### 4.1.1.5 Duration of treatment period
...
#### 4.1.1.6 The intervention administered
...
#### 4.1.1.7 The efficacy of the drug (i.e. whether the drug is a partial or full agonist)
...
#### 4.1.1.8 The selectivity of the drug
...
#### 4.1.1.9 Potency of intervention
...
##### 4.1.1.10.1 SEP-363856 (Ultaront)
...
#### 4.1.1.11 SYRCLE RoB assessment
...
#### 4.1.1.12 ARRIVE reporting completeness guidelines
...
#### 4.1.1.13 Heterogeneity explained by covariates (TAAR1 Agonist v Control on locomotor activity)
...
#### 4.1.2.2 Category of disease induction
...
#### 4.1.2.3 Route of intervention administration
...
#### 4.1.2.4 Prophylactic or therapeutic intervention
...
#### 4.1.2.5 Duration of treatment period
...
#### 4.1.2.6 The intervention administered
...
#### 4.1.2.7 The efficacy of the drug (i.e. whether the drug is a partial or full agonist)
...
#### 4.1.2.8 The selectivity of the drug
...
#### 4.1.2.9 Potency of intervention
...
#### 4.1.2.11 SYRCLE RoB assessment
...
#### 4.1.2.12 ARRIVE reporting completeness guidelines
...
#### 4.1.2.13 Heterogeneity explained by covariates (TAAR1 Agonist v Control on cognition)
...
## 5.1 Sensitivity analyses for TAAR1 Agonist v Control

<!--# as for the meta-regressions, are you only running sensitivity analyses for this experiment type? if so, remove heading and state above-->

### 5.1.1 Locomotor activity

#### 5.1.1.1 Studies with low overall risk of bias
...
#### 5.1.1.2 Imputed rho values of 0.2 and 0.8
...
#### 5.1.2.1 Studies with low overall risk of bias

In this iteration of the review, 0 studies had an overall low risk of bias. A study was categorised as having a low risk of bias if it met at least half of the SYRCLE checklist criteria. Therefore, no sensitivity analysis was performed.

#### 5.1.2.2 Imputed rho values of 0.2 and 0.8
...
## 6.1 Egger regression for small-study effects
