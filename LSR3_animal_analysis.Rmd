...
<!--# should we specify that they are nested? -->
...
<!--# we need an explanation about the studies/experiments with missing values or very large SMDs (beyond 6 in absolute value) - these are excluded in the analysis function in util.R but I don't know if they have been accounted for in the PRISMA -->
...
<!--# is the prediction interval not produced at all for this analysis? I don't see it in the forest plot but, unlike the previous comparisons, no text was added here. -->
