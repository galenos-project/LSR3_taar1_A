...
**Figure 2.1.1a - SyRCLE risk of bias summary for locomotor activity**

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height = 8}
SyRCLE_RoB_summary(df, "TvC", "Locomotor activity")
```

**Figure 2.1.1b - Traffic light plot of the risk of bias for locomotor activity**
...
**Figure 2.1.2a - Reporting completeness summary based on ARRIVE guidelines for locomotor activity**

```{r warning=FALSE, eval = TRUE, echo = FALSE, fig.height = 7}
ARRIVE_summary(df, "TvC", "Locomotor activity")
```

**Figure 2.1.2b - Traffic light plot of the reporting completeness for locomotor activity**
...
**Figure 2.1.4.9 - Subgroup analysis of TAAR1 agonist vs control on locomotor activity by potency of intervention**
...
**Figure 2.1.4.13 - Subgroup analysis of TAAR1 agonist vs control on locomotor activity by ARRIVE criteria met**
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, fig.height=20, fig.width=12}
forest_metafor(SMD_S_LMA_RVE, "TvC", "Locomotor activity")
...
**Figure 2.2.1a -SyRCLE risk of bias summary for cognitive function**

```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE}
SyRCLE_RoB_summary(df, "TvC", "Cognition")
```

**Figure 2.2.1b - Traffic light plot of the risk of bias for cognitive function**
...
**Figure 2.2.2a - Reporting completeness summary based on ARRIVE guidelines for cognitive function**
...
**Figure 2.2.4.6 - Subgroup analysis of TAAR1 agonist vs control on cognitive function by potency of the interventions**
...
**Figure 2.2.4.10 - Subgroup analysis of TAAR1 agonist vs control on cognitive function by ARRIVE criteria met**
...
**Figure 2.2.4.11 - Meta regression of number of ARRIVE items met for TAAR1 agonist vs control on cognitive function**
