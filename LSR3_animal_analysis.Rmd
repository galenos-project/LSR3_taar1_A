...
2.  TAAR1 Agonists v Control: Outcome 1: Locomotor activity
    ...
    -   2.4 Subgroup analyses and meta-regression
        ...
        -   2.4.12 ARRIVE guideline reporting completeness

        -   2.4.13 Heterogeneity explained by covariates
        
    -   2.5  Sensitivity Analyses

        -   2.5.1 Sensitivity to different assumprions for imputed rho values

        -   2.5.2 Sensitivity to analysis using NMD rather than SMD
...
3.  TAAR1 Agonists v Control: Outcome 2: Cognition
    ...
    -   3.4 Subgroup analyses and meta-regression
        ...
        -   3.4.12 ARRIVE guideline reporting completeness 

        -   3.4.13 Heterogeneity explained by covariates
        
    -   3.5  Sensitivity Analyses

        -   3.5.1 Sensitivity to different assumprions for imputed rho values

        -   3.5.2 Sensitivity to analysis using NMD rather than SMD
