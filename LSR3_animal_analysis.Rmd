...
Between-strain variance was `r SMD_S_LMA_PC$sigma2[1]`, between-study variance was `r SMD_S_LMA_PC$sigma2[2]`, and within-study variance (between experiments) was `r SMD_S_LMA_PC$sigma2[3]` \### 4.3.2 Outcome 2: Cognition (a secondary outcome)
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide', fig.width=12, fig.height=5}
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = FALSE, results='hide', fig.width=11, fig.height=5}
...
<!--# why here you use SortLabel=="TvC" to filter the experiments instead of ExperimentType == "Simple intervention (T v Cont)" as for Locomotor activity? the two variables does not seem to be the same-->
