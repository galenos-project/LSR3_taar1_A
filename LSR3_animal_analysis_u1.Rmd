...
original_data <- tab2[1:89, 1:7]


# Rows to have bold lines beneath
rows_with_bold_lines <- c(1,3,4,9,10,11,13,14,15,21,27,30,31,40,42,49,50,51,52,53,63,78,79,81)
...
References of included studies are located in the appendix. Included studies used `r nrow(unique(df[,c(435,436,437,61:72)]))` unique disease model induction procedures.
