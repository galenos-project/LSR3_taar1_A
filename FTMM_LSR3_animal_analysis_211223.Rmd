...
| Moderator | \( \beta \) | 95% CI | \( \tau^2 \) | Test of moderator effect |
|:---:|:---:|:---:|:---:|
...
| *Category of disease induction* | `r SMD_S_LMA_CatDisInd$subgroup_analysis$sigma2[2]` |
| *Route of intervention administration* | `r SMD_S_LMA_AdminRoute$subgroup_analysis$sigma2[2]` |
| *Prophylactic or therapeutic intervention* | `r SMD_S_LMA_ProphThera$subgroup_analysis$sigma2[2]` |
| *The intervention administered* | `r SMD_S_LMA_Drug$subgroup_analysis$sigma2[2]` |
| *Drug efficacy* | `r SMD_S_LMA_DrugEfficacy$subgroup_analysis$sigma2[2]` |
| *Drug selectivity* | `r SMD_S_LMA_DrugSelectivity$subgroup_analysis$sigma2[2]` |
| Unadjusted results | `r SMD_S_LMA$sigma2[2]` |
